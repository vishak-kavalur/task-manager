...
const usersById = (state = {}, action) => {
  switch (action.type) {
    case "ADD_USER": {
      ...
      return { ...state, [userId]: { text: userName, _id: userId } };
    }
    case "CHANGE_USER_NAME": {
      const { userName, userId } = action.payload;
      return { ...state, [userId]: { ...state[userId], text: userName } };
    }
    case "DELETE_USER": {
...
const cardsById = (state = {}, action) => {
  switch (action.type) {
    ...
    case "ASSIGN_USER": {
      const { cardId, userName, userId } = action.payload;
      return { ...state, [cardId]: { ...state[cardId], userName: userName, userId: userId } };
    }

    case "REMOVE_USER": {
      const { cardId } = action.payload;
      return { ...state, [cardId]: { ...state[cardId], userName: null, userId: null } };
    }
